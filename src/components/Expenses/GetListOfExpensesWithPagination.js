...
const onChangePage = (selectedPage) => {
	...
	const { loading, error, data, refetch } = useQuery(LIST_ALL_EXPENSES_WITH_PAGINATION_AND_CATEGORIES, { variables: { page: page, pageSize: defaultPageSize }, fetchPolicy: 'no-cache', notifyOnNetworkStatusChange: true })
